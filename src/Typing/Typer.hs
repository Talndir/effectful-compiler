...
{------------------------------------------------------------------------------
    This module implements the typechecker. Stock and custom effects are
    used to create a type inference DSL. Error reporting is boosted by
    reinterpreting thrown errors with the throwing context; this is not a
    trace like with the parser.
------------------------------------------------------------------------------}
...
reThrow :: String -> Handler '[Throw String] '[Get (M, S), Throw String, Get [Pos]] '[] '[]
